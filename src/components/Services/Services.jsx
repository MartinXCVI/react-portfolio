    ...
    <section className="services-wrapper">
      ...
      <section className="services-section">
        <ServiceCard 
          ...
          text={'Your site will display correctly in any device, be it desktop, phones or tablets. Making it adaptive and accessible is a must in today\'s web standards'}
        />
        <ServiceCard 
